...
/// Shared fixture-directory helper for `SkillWatcherTests` and
/// `SkillsRegistryReloadTests` -- both drive a real, watched temp directory
/// tree and need an identical way to create one (mirrors
